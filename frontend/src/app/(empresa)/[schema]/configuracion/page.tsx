      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight flex items-center gap-2.5">
            ...
            <span>Configuración y Parámetros de Liquidación</span>
          </h1>
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold shadow-sm transition self-start sm:self-auto disabled:opacity-50"
        >
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm space-y-4">
          <div className="flex items-center gap-3 border-b border-slate-100 pb-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Régimen tributario y de hidrocarburos del Estado Plurinacional</p>
            </div>
          </div>

          <div className="p-3.5 rounded-xl bg-blue-50/70 border border-blue-100 text-xs text-blue-900 leading-relaxed flex items-start gap-3">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-white border border-slate-300 rounded-lg p-3 text-xs text-slate-800 focus:outline-none focus:border-blue-600 leading-relaxed"
            />
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm space-y-4">
          <div className="flex items-center gap-3 border-b border-slate-100 pb-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Límites permisibles de evaporación y transporte por tipo de producto</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-white border border-slate-300 rounded-lg px-3.5 py-2 text-slate-900 font-mono text-sm focus:outline-none focus:border-blue-600"
              />
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm space-y-4">
          <div className="flex items-center gap-3 border-b border-slate-100 pb-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Comisiones porcentuales, retenciones y costos logísticos fijos</p>
            </div>
          </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm space-y-4">
          <div className="flex items-center gap-3 border-b border-slate-100 pb-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Nombres y cargos que se imprimen en los 4 bloques de firma</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-white border border-slate-300 rounded-lg px-3.5 py-2 text-slate-900 text-xs focus:outline-none focus:border-blue-600"
              />
            </div>
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            disabled={saving}
            className="px-6 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold shadow-sm flex items-center gap-2 transition disabled:opacity-50"
          >
            <Save className="w-4 h-4" />
